 ...
 * @since 2.2
 */
public class PowellOptimizer2 extends MultivariateOptimizer {
	// This exists so we can return a value 
	// even if the max iterations are exceeded
	 ...
	 */
	public PowellOptimizer2(double rel,
			double abs,
	...
	protected PointValuePair doOptimize() {
		...
		while (true) {
			...
			try{
				...
				fX2 = lastFX2;
				//System.out.println("Breaking at too many evals");
				//break;
			}
	...
	private class LineSearch extends BrentOptimizer {
		...
		UnivariatePointValuePair lastPair; 
		/**
		...
		public UnivariatePointValuePair search(final double[] p, final double[] d) {
			...
			final UnivariateFunction f = new UnivariateFunction() {
				public double value(double alpha) {
					...
					final double obj = PowellOptimizer2.this.computeObjectiveValue(x);
					return obj;
				}
			};

			final GoalType goal = PowellOptimizer2.this.getGoalType();
			...
			try{
				...
				lastPair = optimize(new MaxEval(Integer.MAX_VALUE),
